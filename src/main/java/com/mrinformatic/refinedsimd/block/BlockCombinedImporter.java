...
public class BlockCombinedImporter extends BlockCableBase {
    public BlockCombinedImporter() {
        super(createBuilder("combined_importer").tileEntity(TileCombinedImporter::new).create());
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RefinedSIMDGui.COMBINED_IMPORTER, player, world, pos, side);
    }
}
